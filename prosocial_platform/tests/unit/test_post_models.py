...
def test_empty_post_rejected():
    user = User.objects.create_user(username="frank", email="f@example.com", password="test-pass-123")
...
def test_text_only_post_valid():
    user = User.objects.create_user(username="gina", email="g@example.com", password="test-pass-123")
...
def test_soft_delete_hides_from_visible_queryset():
    user = User.objects.create_user(username="hank", email="h@example.com", password="test-pass-123")
